...
Observe o seu dia de ontem e procure duas situações: uma em que dois usos diferentes do seu tempo tiveram a mesma duração, e uma em que uma mesma quantidade foi repartida de dois modos diferentes.

**Registre:** cada situação em uma linha e a igualdade matemática em que ela se transforma.

**Responda:** a busca saiu tão fácil ou tão difícil quanto você tinha previsto?

**Confira você mesmo:** faça a conta dos dois lados de cada igualdade que você escreveu. Se os dois lados derem números diferentes, aquela situação não é um caso de duas coisas que valem o mesmo.
...
**Confira você mesmo:** aplique a sua regra ao contrário, do último termo de volta para o primeiro. Se você não voltar ao número inicial, a regra está errada.
...
**Responda:** qual é o erro, qual é a resposta certa e qual operação Bruno deveria ter usado?
...
Escreva o número do dia de hoje e os números dos quatro dias seguintes, com a regra dessa primeira sequência. Depois escreva o número do dia de hoje e os números dos quatro próximos dias em que voltará a cair o mesmo dia da semana de hoje, com a regra dessa segunda sequência.

**Responda:** qual das duas regras bateu com a sua previsão, e por quê?
...
**Confira você mesmo:** coloque o valor encontrado de volta na sentença. Se ela ficar verdadeira, a resolução está certa; se ficar falsa, o ▢ foi calculado errado.
...
**Responda, em cinco linhas e para quem faltou à aula:** por que esses dois pontos caem em lugares diferentes mesmo tendo os mesmos dois números?
...
**Confira você mesmo:** as instruções da ida e as da volta precisam ter os mesmos números e os sentidos contrários. Se não tiverem, há erro em uma das duas.
...
**Responda:** o que Júlia confundiu, e como se lê corretamente um par ordenado?
...
Percorra o caminho contando os passos de cada trecho reto.

**Registre:** para cada trecho, quantos passos ele teve e se ele foi para o lado ou para a frente.

**Responda:** qual é o par ordenado que resume o percurso inteiro — o total de passos para o lado e o total de passos para a frente —, e por que a ordem desses dois números importa?
...
**Responda:** quais são as coordenadas dos três novos vértices?

**Confira você mesmo:** conte os quadrados de cada lado nas duas figuras — as medidas precisam ser iguais uma a uma. Se alguma mudou, algum vértice não fez o mesmo deslocamento.
...
**Responda:** em que ponto está o erro, por que é erro, a que distância do eixo o vértice deveria ficar e qual é o cuidado que serve para qualquer reflexão na malha?
...
Toda linha do seu mapa precisa ter um rótulo escrito dizendo qual é a relação, e os termos mais gerais precisam ficar no topo.

**Responda:** quais dois termos você descartou, e por que cada um foi descartado?
