...
**Responda:** o que falta nessa explicação, e que razão prática o capítulo aponta para a criação da escrita alfabética?
...
**Confira você mesmo:** as três erradas trocam coisas diferentes — uma troca comércio por conquista, outra troca o alcance pelo lugar de origem, e a terceira inverte o efeito do relevo montanhoso. Escreva, para cada uma, o que foi trocado pelo quê.
...
**Confira você mesmo:** as três erradas erram em pontos diferentes — uma no tempo em que a obra foi feita, outra em quem a fez, e a terceira na finalidade dela. Se as suas três justificativas apontaram o mesmo ponto, duas ainda não estão prontas.
...
- três biomas terrestres, cada um em uma faixa de latitude diferente;
- título e legenda;
- para cada bioma, o clima que o condiciona.
...
**Responda:** qual é a temperatura média anual de cada uma das duas cidades, e qual é a fonte e o ano de cada dado? E que fatores climáticos do capítulo explicam a diferença entre elas?
...
**Responda:** o que está certo e o que está errado nessa frase? Reescreva-a, ao final, distinguindo o efeito estufa natural do intensificado.
...
**Confira você mesmo:** não basta dizer que as três não são clima — a questão pede o nome do que cada uma descreve, e as três descrevem coisas de tipos diferentes. Se você escreveu *"não é clima"* nas três, ainda não respondeu à pergunta em nenhuma delas.
...
**Confira você mesmo:** três das quatro chegam à mesma conclusão, e só uma chega por um motivo que se sustenta. Portanto duas das suas justificativas **não** podem ser *"a ordem está trocada"* — a ordem delas está certa, e o que falha é o critério que elas usam para separar os dois processos.
...
**Responda:** qual das duas políticas tornaria o império mais duradouro, e que critério você aplicou para decidir? E que custo essa escolha impõe ao poder central?
...
**Confira você mesmo:** as três erradas tratam a fonte de maneiras diferentes — uma aceita como descrição o nome que lhe deram depois, outra descarta a fonte inteira por ela ser interessada, e a terceira tira dela uma conclusão maior do que ela sustenta. Nomeie, para cada uma, qual desses três tratamentos ela dá ao cilindro.
...
**Confira você mesmo:** cada uma das três erradas é derrubada por uma informação diferente do capítulo — uma pelo modo como Ciro governava os povos conquistados, outra pelo que o capítulo diz sobre o zoroastrismo hoje, e a terceira por quem professava essa religião. Escreva, para cada uma, qual informação a derruba.
