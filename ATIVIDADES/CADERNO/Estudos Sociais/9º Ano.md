...
- título e legenda;
- as sub-regiões estudadas;
- três países em cada sub-região.
...
- título e legenda;
- as sub-regiões da Ásia;
- as três maiores cadeias montanhosas ou bacias hidrográficas.
...
**Responda:** qual é a população e a densidade de cada um dos cinco países, e qual é a fonte e o ano dos dados? E por que o país mais populoso não é necessariamente o mais denso?
...
- a região de origem;
- o princípio central;
- a influência sobre a organização social local.
...
**Responda:** qual é o erro dessa afirmação, e quais são os fatores que de fato explicam a concentração populacional asiática? Reescreva, ao final, a frase corretamente.
...
- o principal limite desse modelo.
...
**Responda:** quais são os dados encontrados, e qual é a fonte e o ano deles? E o que a composição dessas trocas revela sobre a posição de cada um dos dois países na economia mundial?
...
- um rótulo em cada linha, dizendo qual é a relação representada;
- o conjunto organizado de modo que fique visível que nenhum dos nove explica sozinho os conflitos da região.
...
- na faixa superior, os marcos da disputa entre Israel e Palestina;
- na faixa inferior, os marcos ligados ao petróleo e às guerras no Golfo;
- pelo menos três ligações cruzadas entre as faixas, cada uma com uma frase que diga como o marco de uma faixa se relaciona com o da outra, usando os mecanismos apresentados no capítulo.
...
- a alta de preços de 1973;
- um rótulo em cada seta, dizendo o que produz o efeito seguinte.
...
**Responda:** qual parte do Anexo sustenta cada afirmação, e em que informação você se apoiou? E qual é a afirmação que nenhuma das duas sustenta, e o que seria preciso saber para sustentá-la?
