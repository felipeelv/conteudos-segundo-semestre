# Estudos Sociais — 8º Ano

> **Bloco 1 · 05/08–25/08** · Independências nas Américas e Brasil no século XIX
...
**Confira você mesmo:** as três erradas mexem em coisas diferentes — uma troca os dois grupos por outros dois, outra apaga a desigualdade entre eles, e a terceira troca o critério que os separa. Escreva, para cada uma, o que ela mexeu.
...
**Confira você mesmo:** as três erradas erram em pontos distintos — uma nega a vitória militar que o próprio caso pressupõe, outra troca uma cobrança imposta por um acordo voluntário, e a terceira inventa uma causa que o caso não traz. Diga qual das três faz o quê.
...
**Confira você mesmo:** não basta escrever *"isso não aconteceu em 1822"* nas três — duas delas aconteceram, só que muito depois, e cada uma tem o seu ano; a terceira não aconteceu de forma alguma. Escreva os dois anos e identifique a que ficou sem ano.
...
**Confira você mesmo:** três das quatro chegam à mesma conclusão, e só uma chega por um motivo que se sustenta. Portanto duas das suas justificativas **não** podem ser *"o movimento não era restritivo aqui"*. Uma dessas duas usa como causa um fato que veio depois; a outra usa uma causa que o capítulo não registra.
...
**Confira você mesmo:** só uma das três erradas é desmentida pelo próprio caso; as outras duas só caem com o que o capítulo diz sobre o Poder Moderador e sobre quem podia votar. Se você descartou as três apenas relendo o caso, duas justificativas ainda não estão prontas.
...
**Confira você mesmo:** as três erradas erram em coisas diferentes — uma inverte o sentido da medida, outra lhe atribui um efeito que ela não teve, e a terceira lhe atribui um conteúdo que ela não tinha. A revolta que durou de 1835 a 1845 é suficiente para derrubar uma delas: diga qual.
