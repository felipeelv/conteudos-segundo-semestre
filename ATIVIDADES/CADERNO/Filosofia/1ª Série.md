...
> **Bloco 1 · 05/08–25/08** · Aristóteles e Escolástica
...
c) O Motor Imóvel é o primeiro objeto material a se mover, e dele vieram todos os outros.  
d) O Motor Imóvel foi uma hipótese que Aristóteles abandonou ao formular as quatro causas.

**Responda:** qual é a afirmação correta, e que erro cada uma das outras três comete?

**Confira você mesmo:** as três erradas fazem coisas de naturezas distintas com o mesmo conceito — uma transforma uma semelhança em identidade, outra transforma um princípio em objeto, e a terceira atribui ao autor um abandono de tese que o capítulo não registra. Nomeie o que cada uma faz.
...
c) A madeira de que a mesa é feita, antes de o marceneiro trabalhá-la.  
d) A estrutura de mesa que organiza aquela madeira num objeto de apoio.

**Responda:** qual das quatro é a substância, e o que é cada uma das outras três?

**Confira você mesmo:** as outras três não são "não-substâncias" — cada uma tem nome próprio no capítulo, e os três nomes são diferentes entre si. Se você escreveu *"não é a coisa em si"* nas três, ainda não respondeu à pergunta em nenhuma delas.
