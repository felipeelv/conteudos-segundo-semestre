...
**Estado:** casa do Bloco 1 fechada (95 capítulos · 624 questões) · casa do Bloco 2 parcial (35 capítulos, em `ACERVO/v2-plano-CADERNO/`) · sala não produzida.
...
| `06-PRODUCAO.md` | **O arquivo operacional.** Marcadores · pool · sorteio com semente · travas · **banco de 22 verbos** (§6) · catálogo de 56 itens em 18 tipos (§5) · molde da folha do aluno (§7.1, com o formato síntese → execução → `Responda:` → `Confira você mesmo:`, os **dois casos de marcador**, o complemento de localização no rótulo e a pergunta em dois tempos — **dois exemplos calibrados**, o das transformações do 8º de Geometria e o dos climogramas da 1ª de Geografia) · as **13 checagens** (§8): §8.1 independência da questão · §8.2 acessibilidade do recurso · §8.3 execução individual | Ao gerar qualquer atividade. É o único que se abre com o teclado na mão |
...
| Disciplina | Anos | Caps. totais | Caps. Bl1 | Questões Bl1 | Casa — Bloco 1 |
|---|---|---:|---:|---:|---|
| Biologia | 9º, 1ª, 2ª | 10 | 5 | 40 | `../CADERNO/Biologia/` |
| Ciências | 4º–8º | 21 | 10 | 64 | `../CADERNO/Ciências/` |
| Estudos Sociais | 4º–9º | 34 | 17 | 102 | `../CADERNO/Estudos Sociais/` |
| Filosofia | 1ª, 2ª | 4 | 2 | 16 | `../CADERNO/Filosofia/` |
| Geografia | 1ª, 2ª | 8 | 4 | 32 | `../CADERNO/Geografia/` |
| Geometria | 6º–9º, 1ª, 2ª | 12 | 6 | 36 | `../CADERNO/Geometria/` |
| História | 1ª, 2ª | 8 | 4 | 30 | `../CADERNO/História/` |
| Matemática EF1 | 4º, 5º | 18 | 8 | 56 | `../CADERNO/Matemática EF1/` |
| Matemática Financeira | 6º–9º, 1ª, 2ª | 12 | 6 | 36 | `../CADERNO/Matemática Financeira/` |
| Português | 4º–9º, 1ª, 2ª | 56 | 28 | 174 | `../CADERNO/Português/` |
| Química | 9º, 1ª, 2ª | 6 | 3 | 22 | `../CADERNO/Química/` |
| Sociologia | 1ª, 2ª | 4 | 2 | 16 | `../CADERNO/Sociologia/` |
| **Total** | **47 anos** | **193** | **95** | **624** | 47 arquivos-ano |
